...
const priceConfig = computed(() => constants.getPriceConfig(props.price))
const color = computed(() => priceConfig.value.colors)
const showPriceText = computed(
  () => props.priceText ?? `CN¥${formatCurrency(props.price)}`,
)
